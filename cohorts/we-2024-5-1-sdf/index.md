...
- Monday, 6/10/24
  ...
  - [Mac Tips & Tricks](./development-tooling-and-practices.md#mac-tips--tricks-️)
  - [Tips & Tricks](./development-tooling-and-practices.md#tips-and-tricks-)
- Tuesday, 6/11/24
...
- [(Reading) Understanding the Rails Application Structure](./route-controller-action-view.md#reading-understanding-the-rails-application-structure)
- [Different Ruby styles 💎](./route-controller-action-view.md#different-ruby-styles-)
- [Introduction to Bootstrap 🥾](./html-css-and-design.md#introduction-to-bootstrap-)
- [Mac Tips & Tricks 🖥️](./development-tooling-and-practices.md#mac-tips--tricks-️)
- [Nesting Routes 🪆](./route-controller-action-view.md#nesting-routes-)
- [Rails: Dice Roll 🎲](./route-controller-action-view.md#rails-dice-roll-)
- [Rails: Omnicalc 1 🧮](./route-controller-action-view.md#rails-omnicalc-1-)
- [Rails: Omnicalc 2 (debugging) 🪳](./route-controller-action-view.md#rails-omnicalc-2-debugging-)
- [Rails: Rock, Paper, Scissors 🪨🧻✂️](./route-controller-action-view.md#rails-rock-paper-scissors-️)
- [Reading Documentation and Newsletters 📰](./writing-documentation-and-asking-questions.md#reading-documentation-and-newsletters-)
- [Records and Relationships 🔗](./domain-modeling.md#records-and-relationships-)
- [Route, Controller, Action, View (RCAV) Flowchart 🚏](./route-controller-action-view.md#route-controller-action-view-rcav-flowchart-)
- [Setup your calendar 📅](./onboarding.md#setup-your-calendar-)
- [Follow up calendar invite 📅](./onboarding.md#follow-up-calendar-invite-)
- [Setup your email 📧](./onboarding.md#setup-your-email-)
- [Follow up email 📧](./onboarding.md#follow-up-email-)
- [Setup Your Internal Profile](./durable-skills.md#setup-your-internal-profile)
...
- [Classroom Queries (Debugging) 🧑‍🏫](./orm-rich-models-and-crud.md#classroom-queries-debugging-)
- [Contact Book: Our very first database 📒](./databases-and-sql.md#contact-book-our-very-first-database-)
- [Debugging 🪳](./development-tooling-and-practices.md#debugging-)
- [Must See Movies Graphical User Interface (GUI) 🎞️](./orm-rich-models-and-crud.md#must-see-movies-graphical-user-interface-gui-️)
- [Must See Movies Queries: Intro to ActiveRecord 🎞️](./orm-rich-models-and-crud.md#must-see-movies-queries-intro-to-activerecord-️)
- [Must See Movies: Data integrity with validations 🧐](./orm-rich-models-and-crud.md#must-see-movies-data-integrity-with-validations-)
- [Nesting Attributes 🪆](./orm-rich-models-and-crud.md#nesting-attributes-)
- [Photogram GUI 📸 🖼️](./orm-rich-models-and-crud.md#photogram-gui--️)
- [Refactoring Must See Movies GUI 1 🎞️](./orm-rich-models-and-crud.md#refactoring-must-see-movies-gui-1-️)
- [Very Best 🏆](./domain-modeling.md#very-best-)
- [Very Best: Entity Relationship Diagram (ERD) 🏆](./domain-modeling.md#very-best-entity-relationship-diagram-erd)
- [Very Best: Spreadsheet 🏆](./domain-modeling.md#very-best-spreadsheet)
- [First Project 🚀](./github-workflow.md#first-project-)
...
- [Delivery Tracker 1 🚚 📦📋](./generators-and-user-accounts.md#delivery-tracker-1--)
- [Delivery Tracker 1: Pull Request URL 🚚 📦📋](./generators-and-user-accounts.md#delivery-tracker-1-pull-request--)
- [How to Write a Good README 📄](./writing-documentation-and-asking-questions.md#how-to-write-a-good-readme-)
- [Must See Movies with Generators](./generators-and-user-accounts.md#must-see-movies-with-generators)
- [Photogram Associations 📸](./generators-and-user-accounts.md#photogram-associations-)
- [Reading: draft:resource generator 🏭](./generators-and-user-accounts.md#reading-draftresource-generator-)
- [Reading: More on User Authentication with Devise](./generators-and-user-accounts.md#reading-more-on-user-authentication-with-devise)
- [Refactoring Must See Movies GUI 2 with Association Accessor Helper Methods 🔄🎥](./generators-and-user-accounts.md#refactoring-must-see-movies-gui-2-with-association-accessor-helper-methods-)
...
- [Helper Methods Part 1: Named routes and links 🏗️](./scaffolding-and-helper-methods.md#helper-methods-part-1-named-routes-and-links-️)
...
- [Photogram Industrial Part 2: Associations, validations, and sample data 📸 🏭](./photogram-industrial-grade.md#photogram-industrial-part-2-associations-validations-and-sample-data--)
- [Photogram Industrial Part 3: Starting user interface 📸 🏭](./photogram-industrial-grade.md#photogram-industrial-part-3-starting-user-interface--)
- [Photogram Industrial Part 4: Profile page 📸 🏭](./photogram-industrial-grade.md#photogram-industrial-part-4-profile-page--)
- [Pull Request URL for Photogram Industrial: photogram-industrial > main 📥📋](./photogram-industrial-grade.md#pull-request-url-for-photogram-industrial-photogram-industrial--main-)
- [Pull Request URL for Photogram Industrial: photogram-industrial > main 📥📋 (giving a code review)](./photogram-industrial-grade.md#pull-request-url-for-photogram-industrial--main--giving-a-code-review)
- [Pull Request URL for Photogram Industrial: profile-page > main 📥📋](./photogram-industrial-grade.md#pull-request-url-for-photogram-industrial-profile-page--main--)
- [Pull Request URL for Photogram Industrial: profile-page > main 📥📋 (giving a code review)](./photogram-industrial-grade.md#pull-request-url-for-photogram-industrial-profile-page--main---giving-a-code-review)
- [Pull Request URL for Photogram Industrial: starting-on-ui > main 📥📋 (giving a code review)](./photogram-industrial-grade.md#pull-request-url-for-photogram-industrial-starting-on-ui--main-)
- [Pull Request URL for Photogram Industrial: starting-on-ui > main 📥📋](./photogram-industrial-grade.md#pull-request-url-for-photogram-industrial-starting-on-ui--main---giving-a-code-review)
- [Pull Request URL for Photogram Industrial: tabbed-interface > main 📥📋](./photogram-industrial-grade.md#pull-request-url-for-photogram-industrial-tabbed-interface--main--)
...
- ["Noticing" a Project Idea 🤔](building-your-own-idea.md#noticing-a-project-idea-)
- [Domain Model: ERD (Entity Relationship Diagram) 📈](./building-your-own-idea.md#domain-model-)
- [Domain Model: Spreadsheet 📋](./building-your-own-idea.md#domain-model-spreadsheet-)
- [Estimating and prioritizing work 🤔](./building-your-own-idea.md#estimating-and-prioritizing-work-)
- [Keep it simple 😽](./building-your-own-idea.md#keep-it-simple-)
- [Pain Points 🥲](./building-your-own-idea.md#pain-points-)
- [Photogram Industrial Authorization 🔒](./authentication-authorization-and-security.md#photogram-industrial-authorization-)
- [Pull Request URL for Photogram Industrial Authorization: add-authorization > main 📥📋](./authentication-authorization-and-security.md#pull-request-url-for-photogram-industrial-authorization-add-authorization--main-)
- [Pull Request URL for Photogram Industrial Authorization: add-authorization > main 📥📋 (giving a code review)](./authentication-authorization-and-security.md#pull-request-for-pundit-policies-add-pundit--main--giving-a-code-review)
- [Pull Request for Pundit Policies: add-pundit > main 📥📋](./authentication-authorization-and-security.md#pull-request-for-pundit-policies-add-pundit--main-)
- [Pull Request for Pundit Policies: add-pundit > main 📥📋 (giving a code review)](./authentication-authorization-and-security.md#pull-request-for-pundit-policies-add-pundit--main--giving-a-code-review)
- [Reading: Authorization with Pundit 🔒](./authentication-authorization-and-security.md#reading-authorization-with-pundit-)
- [Sketches ✍️](./building-your-own-idea.md#sketches-️)
- [User Feedback 🗣️](./building-your-own-idea.md#user-feedback-️)
- [User Stories 📖](./building-your-own-idea.md#user-stories-)
